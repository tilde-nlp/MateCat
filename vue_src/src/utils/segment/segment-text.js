...
const editorStart = '<span class="editor-span" onclick="onEditor(this)" onfocus="onEditor(this)" onblur="onEditor(this)" onkeyup="onEditor(this)" onpaste="onEditor(this)" oncut="onEditor(this)" onmouseup="onEditor(this)" onkeydown="onPress(event, this)" contenteditable="false">'
